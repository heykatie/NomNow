      ...
      <div id="footer">
        ...
        <div className='footer-right'>
          <div className='footer-contact'>
            ...
            <a href="https://heykatie.github.io/" target="_blank" rel="noopener noreferrer">
              <div>Gabriel Dean</div>
              </a>
              <div className='footer-links'>
                <a href="https://www.linkedin.com/in/gabriel-dean" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://heykatie.github.io/" target="_blank" rel="noopener noreferrer">
              ...
              <div className='footer-links'>
                <a href="https://www.linkedin.com/in/samai-althiabat" target="_blank" rel="noopener noreferrer">
                  <i className="fa-brands fa-linkedin"></i>
                </a>
            ...
            <a href="https://heykatie.github.io/" target="_blank" rel="noopener noreferrer">
              ...
              <div className='footer-links'>
                <a href="https://www.linkedin.com/in/katieleonght/" target="_blank" rel="noopener noreferrer">
                  <i className="fa-brands fa-linkedin"></i>
                </a>
            ...
            <div className='footer-name'>
            <a href="https://mcode4.github.io/" target="_blank" rel="noopener noreferrer">
              <div>Marcelle Armstrong</div>
              </a>
              <div className='footer-links'>
                <a href="https://www.linkedin.com/in/marcellies-armstrong/" target="_blank" rel="noopener noreferrer">
                  <i className="fa-brands fa-linkedin"></i>
                </a>

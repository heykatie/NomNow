...
from app.models.restaurants import cuisine_type, price_level
...
def seed_restaurants():
    restaurants = [
        Restaurant(
            ...
            zip=10002,
            name="Taco Casa",
            cuisine_type=cuisine_type.MEXICAN,
            delivery_fee=3.99,
            ...
            price_level=price_level.INEXPENSIVE,
            delivery_time=30,
        ),
        Restaurant(
            owner_id=1,
            ...
            price_level=price_level.MODERATE,
            delivery_time=35,
        ),
        Restaurant(
            owner_id=2,
            ...
            zip=10018,
            name="Olive Grove",
            cuisine_type=cuisine_type.MEDITERRANEAN,
            delivery_fee=4.99,
        ...
        Restaurant(
            ...
            price_level=price_level.EXPENSIVE,
            delivery_time=45,
        ),
        Restaurant(
            owner_id=3,
            ...
            zip=10016,
            name="Thai Orchid",
            cuisine_type=cuisine_type.THAI,
            delivery_fee=3.99,
            ...
            price_level=price_level.VERY_EXPENSIVE,
            delivery_time=35,
        ),
        Restaurant(
            owner_id=3,

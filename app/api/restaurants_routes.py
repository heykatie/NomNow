...
def get_current_user_restaurants():
    restaurants = Restaurant.query.filter(Restaurant.ownerId == current_user.id).all()
    restaurant_list = []
    for restaurant in restaurants:
...
def create_restaurant():
    ...
    return {'errors': [error for field in form.errors for error in form.errors[field]]}, 400
